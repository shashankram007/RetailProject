...
if __name__ == '__main__':
    ...
    # Logging can be done only after creating spark session.
    logger = Log4j(spark)
    ...
    customers_state_aggregate = DataManipulation.count_orders_state(customers_df)
    customers_state_aggregate.write \
        .format("csv") \
        .option("header", True) \
        .mode("overwrite") \
        .csv("data\\results_csv")
